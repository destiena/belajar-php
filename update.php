...
<body>
    ...
    <form action="update.php" method="post">
        ...
        Tanggal Lahir (yyyy-mm-dd): <input type="text" name="tgl_lahir" value="<?php echo $mahasiswa['alamat']; ?>"><br>
        Alamat: <input type="text" name="alamat" value="<?php echo $mahasiswa['nim']; ?>"><br>
